...
type_jobs = {
    ...
    "ESTJ": ["💼 경영자", "🏛 정치가", "🎖 군 장교"],
    "ESFJ": ["🤲 사회복지사", "👩‍🏫 교사", "🏥 간호사"],
    "ISTP": ["⚙️ 기계공학자", "🚑 응급구조사", "⚽ 운동선수"],
    "ISFP": ["👗 패션 디자이너", "🎨 예술가", "🎶 작곡가"],
    "ESTP": ["💼 영업사원", "🏋️ 스포츠 코치", "📰 기자"],
    "ESFP": ["🎤 배우", "🌟 연예인", "🎉 이벤트 플래너"]
}
...
with title_col1:
    st.image("https://em-content.zobj.net/source/microsoft-teams/337/crystal-ball_1f52e.png", width=60)
with title_col2:
    st.title("MBTI 기반 직업 추천 🎯")

# 설명
st.markdown("""
✨ **자신의 MBTI 유형을 선택하면 적절한 직업을 추천해드립니다.**

🔍 성격 유형에 따른 진로를 알아보고, 꿈을 확장해보세요!
""")
